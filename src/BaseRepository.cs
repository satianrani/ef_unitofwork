...
namespace Threenine.Data
{
    public abstract class BaseRepository<T> : IReadRepository<T> where T : class
    {
        ...
        public IPaginate<T> GetListPaging(Expression<Func<T, bool>> predicate = null,
            Func<IQueryable<T>, IOrderedQueryable<T>> orderBy = null,
        ...
        public IPaginate<TResult> GetListPaging<TResult>(Expression<Func<T, TResult>> selector,
